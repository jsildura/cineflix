    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <p className="footer-disclaimer">
          <strong className="footer-brand">CineFlix</strong> operates strictly as a search index and does not host any media files on its servers. All content is provided by non-affiliated third parties. Any copyright concerns should be directed to the respective file hosting services. <strong className="footer-brand">CineFlix</strong> exercises no control over, and accepts no liability for, any media files distributed by external hosting services.
        </p>

        {/* Copyright */}
        <p className="footer-copyright">© {currentYear} CineFlix All rights reserved.</p>
      </div>
    </footer>
  );
};
