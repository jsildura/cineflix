...
const Disney = () => {
    ...
    // Initial fetch of Disney+ content
    useEffect(() => {
        const fetchInitialContent = async () => {
            try {
                ...
                for (let page = 1; page <= 5; page++) {
                    moviePromises.push(
                        fetch(`/api/discover/movie?with_watch_providers=337&watch_region=US&sort_by=popularity.desc&page=${page}`)
                    );
                    tvPromises.push(
                        fetch(`/api/discover/tv?with_watch_providers=337&watch_region=US&sort_by=popularity.desc&page=${page}`)
                    );
                }
                ...
                <div className="disney-page-header">
                    ...
                    <div className="disney-page-title-section">
                        <img
                            ...
                            alt="Disney+"
                            className="disney-page-logo"
                        />
                        <h1 className="disney-page-title">Disney+ Originals</h1>
                    </div>
                </div>
                <div className="disney-page-loading">
                    <div className="loading-spinner"></div>
                    <p>Loading Disney+ content...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="disney-page">
            ...
            <div className="disney-page-header">
                ...
                <p className="disney-page-subtitle">
                    Popular movies and TV shows available on Disney+
                </p>
            </div>
            ...
            <section className="disney-section">
                <div className="disney-section-header">
                    ...
                    <span className="disney-section-count">{movies.length} titles</span>
                </div>
                ...
                {moviesPage < moviesTotalPages && (
                    <div className="load-more-container">
                        <button
                            className="load-more-btn disney-load-more"
            ...
            <section className="disney-section">
                <div className="disney-section-header">
                    ...
                    <span className="disney-section-count">{tvShows.length} titles</span>
                </div>
                <div className="disney-grid">
                    {tvShows.map(show => (
                        <MovieCard
